...
HXLINE( 405)							Float y1 = ((::Math_obj::ceil((((group1->offsetY + scrollY) + group1->ascent) - bounds->y)) + descent) + ((Float)0.5));
...
HXLINE( 425)				Float r3 = (( (Float)(::hx::UShr((( (int)(color3) ) & 16711680),16)) ) / ( (Float)(255) ));
HXLINE( 426)				Float g3 = (( (Float)(::hx::UShr((( (int)(color3) ) & 65280),8)) ) / ( (Float)(255) ));
HXLINE( 427)				Float b3 = (( (Float)((( (int)(color3) ) & 255)) ) / ( (Float)(255) ));
