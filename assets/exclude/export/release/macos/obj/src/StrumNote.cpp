...
HXLINE( 139)			_hx_tmp1 = !(::PlayState_obj::isPixelStage);
            		}
            		else {
...
HXLINE( 156)				_hx_tmp1 = (this->noteData < ::ClientPrefs_obj::arrowHSV->length);
            			}
            			else {
...
HXLINE( 163)				_hx_tmp2 = !(::PlayState_obj::isPixelStage);
            			}
            			else {
HXLINE( 163)				_hx_tmp2 = false;
            			}
HXDLIN( 163)			if (_hx_tmp2) {
HXLINE( 164)				 ::flixel::math::FlxBasePoint this2 = this->origin;
HXDLIN( 164)				Float y1 = (( (Float)(this->frameHeight) ) * ((Float)0.5));
HXDLIN( 164)				this2->set_x((( (Float)(this->frameWidth) ) * ((Float)0.5)));
