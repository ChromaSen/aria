...
HXDLIN( 248)					 ::Dynamic _g_value = ::haxe::IMap_obj::get(_g_map,key);
HXDLIN( 248)					::String _g_key = key;
HXDLIN( 248)					::String name = _g_key;
HXDLIN( 248)					 ::Dynamic value = _g_value;
...
HXLINE( 274)			{
HXLINE( 274)				::Dynamic map1 = loadedControls;
HXDLIN( 274)				::Dynamic _g_map1 = map1;
HXDLIN( 274)				 ::Dynamic _g_keys1 = ::haxe::IMap_obj::keys(map1);
HXDLIN( 274)				while(( (bool)(_g_keys1->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 274)					::String key1 = ( (::String)(_g_keys1->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXDLIN( 274)					::Array< int > _g_value1 = ( (::Array< int >)(::haxe::IMap_obj::get(_g_map1,key1)) );
HXDLIN( 274)					::String _g_key1 = key1;
HXDLIN( 274)					::String control = _g_key1;
HXDLIN( 274)					::Array< int > keys = _g_value1;
