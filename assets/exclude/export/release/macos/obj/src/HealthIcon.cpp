...
HXLINE(  41)				::String key2 = key;
HXDLIN(  41)				if (::hx::IsNull( key2 )) {
HXLINE(  41)					key2 = HX_("",00,00,00,00);
            				}
HXDLIN(  41)				_hx_tmp1 = ::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + key2));
            			}
            			else {
...
HXLINE(  42)			::String key3 = ((HX_("images/",77,50,74,c1) + name) + HX_(".png",3b,2d,bd,1e));
HXDLIN(  42)			bool _hx_tmp2;
HXDLIN(  42)			bool _hx_tmp3;
HXDLIN(  42)			::String key4 = ((::Paths_obj::currentModDirectory + HX_("/",2f,00,00,00)) + key3);
HXDLIN(  42)			if (::hx::IsNull( key4 )) {
HXLINE(  42)				key4 = HX_("",00,00,00,00);
            			}
HXDLIN(  42)			if (!(::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + key4)))) {
HXLINE(  42)				::String key5 = key3;
HXDLIN(  42)				if (::hx::IsNull( key5 )) {
HXLINE(  42)					key5 = HX_("",00,00,00,00);
            				}
HXDLIN(  42)				_hx_tmp3 = ::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + key5));
            			}
            			else {
...
HXLINE(  42)				if (::openfl::utils::Assets_obj::exists(::Paths_obj::getPath(key3,HX_("IMAGE",3b,57,57,3b),null()),null())) {
HXLINE(  42)					_hx_tmp2 = true;
            				}
            				else {
