...
HXDLIN(  66)				bg1->set_x(((( (Float)(_hx_tmp1) ) - bg1->get_width()) / ( (Float)(2) )));
            			}
...
HXDLIN(  66)				bg1->set_y(((( (Float)(_hx_tmp3) ) - bg1->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXDLIN(  76)						optionText->set_x(((( (Float)(_hx_tmp5) ) - optionText->get_width()) / ( (Float)(2) )));
            					}
...
HXDLIN(  76)						optionText->set_y(((( (Float)(_hx_tmp7) ) - optionText->get_height()) / ( (Float)(2) )));
            					}
            				}
...
HXLINE( 135)					 ::Alphabet _hx_tmp1 = this->selectorRight;
HXDLIN( 135)					Float item1 = item->x;
HXDLIN( 135)					_hx_tmp1->set_x(((item1 + item->get_width()) + 15));
HXLINE( 136)					this->selectorRight->set_y(item->y);
            				}
            			}
            		}
HXLINE( 139)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp2 = ::flixel::FlxG_obj::sound;
HXDLIN( 139)		_hx_tmp2->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),null(),null(),null(),null(),null());
            	}
