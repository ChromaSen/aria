...
HXLINE( 584)				ret1 = cbf();
            			...
            			break;
            			case (int)1: {
HXLINE( 586)				ret1 = cbf(args->__get(0));
            			}
            			break;
            			case (int)2: {
HXLINE( 588)				ret1 = cbf(args->__get(0),args->__get(1));
            			}
            			break;
            			case (int)3: {
HXLINE( 590)				ret1 = cbf(args->__get(0),args->__get(1),args->__get(2));
            			}
            			break;
            			case (int)4: {
HXLINE( 592)				ret1 = cbf(args->__get(0),args->__get(1),args->__get(2),args->__get(3));
            			}
            			break;
            			case (int)5: {
HXLINE( 594)				ret1 = cbf(args->__get(0),args->__get(1),args->__get(2),args->__get(3),args->__get(4));
            			}
            			break;
            			case (int)6: {
HXLINE( 596)				ret1 = cbf(args->__get(0),args->__get(1),args->__get(2),args->__get(3),args->__get(4),args->__get(5));
            			}
            			break;
            			case (int)7: {
HXLINE( 598)				ret1 = cbf(args->__get(0),args->__get(1),args->__get(2),args->__get(3),args->__get(4),args->__get(5),args->__get(6));
            			}
            			break;
            			case (int)8: {
HXLINE( 600)				ret1 = cbf(args->__get(0),args->__get(1),args->__get(2),args->__get(3),args->__get(4),args->__get(5),args->__get(6),args->__get(7));
            			}
            			break;
            			default:{
HXLINE( 602)				HX_STACK_DO_THROW(HX_("> 5 arguments is not supported",62,23,e5,68));
            			}
            		}
HXLINE( 605)		if (::hx::IsNotNull( ret1 )) {
HXLINE( 606)			::llua::Convert_obj::toLua(l,ret1);
            		}
HXLINE( 610)		return 1;
            	}
