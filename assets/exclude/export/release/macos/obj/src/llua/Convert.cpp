...
HXDLIN(  30)					{
HXLINE(  30)						int _g1 = 0;
HXDLIN(  30)						::Array< ::String > _g2 = ::Reflect_obj::fields(val);
HXDLIN(  30)						while((_g1 < _g2->length)){
HXLINE(  30)							::String n = _g2->__get(_g1);
HXDLIN(  30)							_g1 = (_g1 + 1);
...
HXDLIN(  30)					{
HXLINE(  30)						int _g3 = 0;
HXDLIN(  30)						::Array< ::String > _g4 = ::Reflect_obj::fields(val);
HXDLIN(  30)						while((_g3 < _g4->length)){
HXLINE(  30)							::String n1 = _g4->__get(_g3);
HXDLIN(  30)							_g3 = (_g3 + 1);
HXDLIN(  30)							lua_pushstring(l,n1);
HXDLIN(  30)							::llua::Convert_obj::toLua(l,::Reflect_obj::field(val,n1));
...
HXDLIN(  28)						{
HXLINE(  28)							int _g5 = 0;
HXDLIN(  28)							int _g6 = size;
HXDLIN(  28)							while((_g5 < _g6)){
HXLINE(  28)								_g5 = (_g5 + 1);
HXDLIN(  28)								int i = (_g5 - 1);
...
HXDLIN(  26)						goto _hx_goto_2;
            					...
            					/* default */{
HXLINE(  32)						 ::Dynamic _hx_tmp1 = ::haxe::Log_obj::trace;
HXDLIN(  32)						::String _hx_tmp2;
HXDLIN(  32)						if (::hx::IsNull( val )) {
HXLINE(  32)							_hx_tmp2 = HX_("null",87,9e,0e,49);
            						}
            						else {
HXLINE(  32)							_hx_tmp2 = ::Std_obj::string(val);
            						}
HXDLIN(  32)						::String _hx_tmp3 = (((HX_("haxe value not supported\n",12,9a,82,3a) + _hx_tmp2) + HX_(" - ",73,6f,18,00)) + ::Std_obj::string(::Type_obj::_hx_typeof(val)));
HXDLIN(  32)						_hx_tmp1(_hx_tmp3,::hx::SourceInfo(HX_("llua/Convert.hx",6e,6a,e3,49),32,HX_("llua.Convert",31,b8,44,19),HX_("toLua",fd,0a,14,14)));
HXLINE(  33)						return false;
            				...
            				break;
            				default:{
HXLINE(  32)					 ::Dynamic _hx_tmp4 = ::haxe::Log_obj::trace;
HXDLIN(  32)					::String _hx_tmp5;
HXDLIN(  32)					if (::hx::IsNull( val )) {
HXLINE(  32)						_hx_tmp5 = HX_("null",87,9e,0e,49);
            					}
            					else {
HXLINE(  32)						_hx_tmp5 = ::Std_obj::string(val);
            					}
HXDLIN(  32)					::String _hx_tmp6 = (((HX_("haxe value not supported\n",12,9a,82,3a) + _hx_tmp5) + HX_(" - ",73,6f,18,00)) + ::Std_obj::string(::Type_obj::_hx_typeof(val)));
HXDLIN(  32)					_hx_tmp4(_hx_tmp6,::hx::SourceInfo(HX_("llua/Convert.hx",6e,6a,e3,49),32,HX_("llua.Convert",31,b8,44,19),HX_("toLua",fd,0a,14,14)));
HXLINE(  33)					return false;
            				}
            			}
            		}
...
HXLINE(  63)				::String n1 = _g3->__get(_g2);
HXDLIN(  63)				_g2 = (_g2 + 1);
HXLINE(  64)				lua_pushstring(l,n1);
HXLINE(  65)				::llua::Convert_obj::toLua(l,::Reflect_obj::field(res,n1));
...
HXLINE( 173)								_hx_tmp1 = (::Std_obj::_hx_int(index) != index);
            							}
            							else {
...
HXLINE( 181)			return  ::Dynamic(::hx::Anon_obj::Create(0));
            		}
            		else {
HXLINE( 182)			if (array) {
...
HXLINE( 184)						{
HXLINE( 185)							int index1 = (::Std_obj::_hx_int(lua_tonumber(l,-2)) - 1);
...
HXLINE( 190)				 ::Dynamic v1 =  ::Dynamic(::hx::Anon_obj::Create(0));
HXLINE(   8)				{
HXLINE(   9)					lua_pushnil(l);
HXLINE(  10)					while(true){
...
HXDLIN( 193)									switch((int)(lua_type(l,-1))){
            										case (int)0: {
HXLINE( 193)											ret1 = null();
            										}
            										break;
            										case (int)1: {
HXLINE( 193)											ret1 = (lua_toboolean(l,-1) != 0);
            										}
            										break;
            										case (int)3: {
HXLINE( 193)											ret1 = lua_tonumber(l,-1);
            										}
            										break;
            										case (int)4: {
HXLINE( 193)											ret1 = linc::lua::tostring(l,-1);
            										}
            										break;
            										case (int)5: {
HXLINE( 193)											ret1 = ::llua::Convert_obj::toHaxeObj(l,-1);
            										}
            										break;
            										default:{
HXLINE( 193)											ret1 = null();
...
HXDLIN( 193)									 ::Dynamic value = ret1;
HXDLIN( 193)									::Reflect_obj::setField(v1,key,value);
            								}
            								else {
HXLINE( 194)									int t1 = _g;
HXDLIN( 194)									if ((t1 == 3)) {
HXLINE( 194)										::String key1 = ::Std_obj::string(lua_tonumber(l,-2));
...
HXLINE( 194)												ret2 = linc::lua::tostring(l,-1);
            											...
            											break;
            											case (int)5: {
HXLINE( 194)												ret2 = ::llua::Convert_obj::toHaxeObj(l,-1);
            											}
            											break;
            											default:{
HXLINE( 194)												ret2 = null();
...
HXDLIN( 194)										 ::Dynamic value1 = ret2;
HXDLIN( 194)										::Reflect_obj::setField(v1,key1,value1);
            									}
            								}
            							}
            						}
