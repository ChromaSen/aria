...
HXLINE(  77)		 ::Dynamic bundle;
HXDLIN(  77)		::String data = HX_("{\"name\":null,\"assets\":\"ah\",\"rootPath\":null,\"version\":2,\"libraryArgs\":[],\"libraryType\":null}",6c,e1,75,d6);
HXDLIN(  77)		 ::lime::utils::AssetManifest manifest = ::lime::utils::AssetManifest_obj::parse(data,::ManifestResources_obj::rootPath);
HXDLIN(  77)		 ::lime::utils::AssetLibrary library = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);
HXLINE(  93)		::lime::utils::Assets_obj::registerLibrary(HX_("videos",98,d7,95,e5),library);
HXLINE(  94)		{
HXLINE(  94)			::String v = (::ManifestResources_obj::rootPath + HX_("manifest/songs.json",38,27,75,ee));
HXDLIN(  94)			::lime::utils::Assets_obj::libraryPaths->set(HX_("songs",fe,36,c7,80),v);
            		}
HXLINE(  95)		{
HXLINE(  95)			::String v1 = (::ManifestResources_obj::rootPath + HX_("manifest/shared.json",f1,c2,0a,f4));
HXDLIN(  95)			::lime::utils::Assets_obj::libraryPaths->set(HX_("shared",a5,5e,2b,1d),v1);
            		}
HXLINE(  96)		{
HXLINE(  96)			::String v2 = (::ManifestResources_obj::rootPath + HX_("manifest/week2.json",78,50,8e,58));
HXDLIN(  96)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week2",be,95,be,c7),v2);
            		}
HXLINE(  97)		{
HXLINE(  97)			::String v3 = (::ManifestResources_obj::rootPath + HX_("manifest/week3.json",d7,ac,e9,be));
HXDLIN(  97)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week3",bf,95,be,c7),v3);
            		}
HXLINE(  98)		{
HXLINE(  98)			::String v4 = (::ManifestResources_obj::rootPath + HX_("manifest/week4.json",36,09,45,25));
HXDLIN(  98)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week4",c0,95,be,c7),v4);
            		}
HXLINE(  99)		{
HXLINE(  99)			::String v5 = (::ManifestResources_obj::rootPath + HX_("manifest/week5.json",95,65,a0,8b));
HXDLIN(  99)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week5",c1,95,be,c7),v5);
            		}
HXLINE( 100)		{
HXLINE( 100)			::String v6 = (::ManifestResources_obj::rootPath + HX_("manifest/week6.json",f4,c1,fb,f1));
HXDLIN( 100)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week6",c2,95,be,c7),v6);
            		}
HXLINE( 101)		{
HXLINE( 101)			::String v7 = (::ManifestResources_obj::rootPath + HX_("manifest/week7.json",53,1e,57,58));
HXDLIN( 101)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week7",c3,95,be,c7),v7);
            		}
HXLINE( 102)		{
HXLINE( 102)			::String v8 = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN( 102)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v8);
            		}
HXLINE( 105)		library = ::lime::utils::Assets_obj::getLibrary(HX_("videos",98,d7,95,e5));
HXLINE( 106)		if (::hx::IsNotNull( library )) {
HXLINE( 106)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 107)			::ManifestResources_obj::preloadLibraryNames->push(HX_("videos",98,d7,95,e5));
            		}
HXLINE( 108)		library = ::lime::utils::Assets_obj::getLibrary(HX_("songs",fe,36,c7,80));
HXLINE( 109)		if (::hx::IsNotNull( library )) {
HXLINE( 109)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 110)			::ManifestResources_obj::preloadLibraryNames->push(HX_("songs",fe,36,c7,80));
            		}
HXLINE( 111)		library = ::lime::utils::Assets_obj::getLibrary(HX_("shared",a5,5e,2b,1d));
HXLINE( 112)		if (::hx::IsNotNull( library )) {
HXLINE( 112)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 113)			::ManifestResources_obj::preloadLibraryNames->push(HX_("shared",a5,5e,2b,1d));
            		}
HXLINE( 114)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week2",be,95,be,c7));
HXLINE( 115)		if (::hx::IsNotNull( library )) {
HXLINE( 115)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 116)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week2",be,95,be,c7));
            		}
HXLINE( 117)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week3",bf,95,be,c7));
HXLINE( 118)		if (::hx::IsNotNull( library )) {
HXLINE( 118)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 119)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week3",bf,95,be,c7));
            		}
HXLINE( 120)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week4",c0,95,be,c7));
HXLINE( 121)		if (::hx::IsNotNull( library )) {
HXLINE( 121)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 122)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week4",c0,95,be,c7));
            		}
HXLINE( 123)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week5",c1,95,be,c7));
HXLINE( 124)		if (::hx::IsNotNull( library )) {
HXLINE( 124)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 125)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week5",c1,95,be,c7));
            		}
HXLINE( 126)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week6",c2,95,be,c7));
HXLINE( 127)		if (::hx::IsNotNull( library )) {
HXLINE( 127)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 128)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week6",c2,95,be,c7));
            		}
HXLINE( 129)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week7",c3,95,be,c7));
HXLINE( 130)		if (::hx::IsNotNull( library )) {
HXLINE( 130)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 131)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week7",c3,95,be,c7));
            		}
HXLINE( 132)		library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
HXLINE( 133)		if (::hx::IsNotNull( library )) {
HXLINE( 133)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 134)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}
