...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("ARIA", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("ARIA", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "4";
		app.meta["company"] = "ARIA";
		app.meta["file"] = "ARIA";
		app.meta["name"] = "Friday Night Funkin': ARIA";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': ARIA",
			width: 1280,
			x: null,
			y: null,
		};
