...
import sys.io.File;
#end
class DebugPause extends MusicBeatSubstate
{
	...
	public function new(x:Float, y:Float)
	{
		...
		debugText = new FlxText(20, 15 + 101, 0, "DEBUG", 32);
		debugText.scrollFactor.set();
		debugText.setFormat(Paths.font('vcr.ttf'), 32);
		debugText.x = FlxG.width - (practiceText.width + 20);
		debugText.antialiasing = ClientPrefs.globalAntialiasing;
		debugText.updateHitbox();
		debugText.visible = PlayState.instance.practiceMode;
		add(debugText);
